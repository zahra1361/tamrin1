...
print(termcolor.colored("---------------------------", color="red"))
...
print(termcolor.colored("---------------------------", color="blue"))
...
if operator == "+":
    ...
    if b == 0:
        print(termcolor.colored("Cannot Divide By Zero", color="red"))
    else:
    ...
    print(termcolor.colored("Error!! TryAgain", color="red"))